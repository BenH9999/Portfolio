            ...
            <div className="text-center z-40">
                ...
                <div className="flex justify-center space-x-4 text-sm md:text-2xl">
                    <a
                        ...
                        className="flex items-center space-x-2 bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.4)]"
                    >
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center border space-x-2 border-blue-500/50 text-blue-500 py-3 px-6 rounded font-medium transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.2)] hover:bg-blue-500/10"
                    >
                    ...
                    <a
                        ...
                        className="flex items-center bg-gradient-to-r space-x-2 from-blue-400 to-purple-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(128,90,213,0.4)]"
                    >
